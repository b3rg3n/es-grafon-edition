...
label day6_main:
    ...
    if _preferences.language != None:
        $ renpy.notify(translation_new["note12"])
...
label day6_us:
    ...
    us "Я и не претендую."
    "Ухмыльнулась Ульяна."
    "Да, она была совершенно права.{w} Подобными качествами я не обладал."
