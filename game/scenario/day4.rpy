...
label day4_std_morning:
    $ backdrop = "days"
    $ new_chapter(4, translation_new["day4"])
    $ day_time()
...
label day4_busstop:
    ...
    window hide
    menu:
        "Пойти с Мику" if True:
            $ day4_mi_accept = 1
            window show
            th "С другой стороны, я же ничего не теряю!"
            "Хотя..."
        "Не ходить с Мику" if True:
            window show
...
label day4_main2:
    ...
    window hide
    menu:
        "Мне кажется, на тебе это бы смотрелось прекрасно" if True:
            $ day4_un_compl = 1
            $ lp_un = lp_un + 1
            window show
            un "Спасибо…"
            me "Да не за что, я же правду говорю!"
        "Да просто так" if True:
            window show
            un "…"
    ...
    window hide
    menu:
        "Небось ворованных конфет объелась?" if True:
            show us dontlike pioneer at center with dspr
            window show
    ...
    menu:
        ...
        "Не давать ей уголь" if True:
            ...
            if _preferences.language != None:
                $ renpy.notify(translation_new["note10"])
...
label un_mine_exit:
    ...
    window hide
    menu:
        "Сказать, что ходил с Леной" if True:
            window show
            me "Нет, с Леной."
            pass
        "Сказать, что ходил один" if True:
            $ lp_un = lp_un + 1
            window show
            me "Да, один."
            pass
