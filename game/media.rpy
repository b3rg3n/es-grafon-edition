...
init:
    ...
    if _preferences.language == "chinese":
        $ style.credits.font  = "fonts/STZHONGS.ttf"
    elif True:
    ...
    if _preferences.language == "chinese":
        $ style.urhere1.font  = "fonts/STZHONGS.ttf"
    elif True:
        $ style.urhere1.font  = "fonts/corbelb.ttf"
    ...
    if _preferences.language == "chinese":
        $ style.urhere2.font  = "fonts/STZHONGS.ttf"
    elif True:
        $ style.urhere2.font  = "fonts/corbelb.ttf"
    ...
    if _preferences.language == "chinese":
        $ style.urhere3.font  = "fonts/STZHONGS.ttf"
    elif True:
        $ style.urhere3.font  = "fonts/corbelb.ttf"
    ...
    if _preferences.language == "chinese":
        $ style.urhere4.font  = "fonts/STZHONGS.ttf"
    elif True:
        $ style.urhere4.font  = "fonts/corbelb.ttf"
    ...
    if _preferences.language == "chinese":
        $ style.urhere5.font  = "fonts/STZHONGS.ttf"
    elif True:
        $ style.urhere5.font  = "fonts/corbelb.ttf"
    ...
    if _preferences.language == "chinese":
        $ style.urhere6.font  = "fonts/STZHONGS.ttf"
    elif True:
        $ style.urhere6.font  = "fonts/corbelb.ttf"
    ...
    if _preferences.language == "chinese":
        $ style.urhere7.font  = "fonts/STZHONGS.ttf"
    elif True:
        $ style.urhere7.font  = "fonts/corbelb.ttf"
    ...
    if _preferences.language == "chinese":
        $ style.urhere8.font  = "fonts/STZHONGS.ttf"
    elif True:
        $ style.urhere8.font  = "fonts/corbelb.ttf"
    ...
    if _preferences.language == "chinese":
        $ style.urhere9.font  = "fonts/STZHONGS.ttf"
    elif True:
        $ style.urhere9.font  = "fonts/corbelb.ttf"
    ...
    if _preferences.language == "chinese":
        $ style.urhere10.font  = "fonts/STZHONGS.ttf"
    elif True:
        $ style.urhere10.font  = "fonts/corbelb.ttf"
...
init:
    ...
    $ names['voice'] = translation_new["voice"]
    ...
    $ names['me'] = translation_new["Semyon"]
    ...
    $ names['my'] = translation_new["Myself"]
    ...
    $ names['unp'] = translation_new["pika"]
    ...
    $ names['csp'] = translation_new["Nurse"]
    ...
    $ names['dreamgirl'] = translation_new["dreamgirl"]
    ...
    $ names['bush'] = translation_new["bush"]
    ...
    $ names['FIXME_voice'] = translation_new["FIXME_voice"]
    ...
    $ names['message'] = translation_new["message"]
    ...
    $ names['mt_voice'] = translation_new["mt_voice"]
...
init:
    if _preferences.language == "english":
        ...
        image widget map = get_image("maps/map_fr.jpg")
    elif True:
...
init -997 python:
    ...
    if _preferences.language == "english":
        ...
        store.map_pics = {
            "bgpic": get_image("maps/map_fr.jpg"),
            "available": get_image("maps/map_fr_available.jpg"),
            "selected": get_image("maps/map_fr_selected.jpg")
        }
    else:
        store.map_pics = {
